...
DEVS = list(map(int, os.getenv("DEVS", "8089494997").split()))

API_ID = int(os.getenv("API_ID", "22693250"))

API_HASH = os.getenv("API_HASH", "153dff0c758234e035207641e9c18a88")

BOT_TOKEN = os.getenv("BOT_TOKEN", "8297214658:AAELI08zD3b6b6RizGWfBviNwJAmDjrJZRY")

OWNER_ID = int(os.getenv("OWNER_ID", "8089494997"))
